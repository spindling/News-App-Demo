...
db.serialize(function(){
  ...
  //hash and salt initial passwords
  const mem1 = bcrypt.hashSync('mem1', 10);
  const mem2 = bcrypt.hashSync('mem2', 10);
  const edit1 = bcrypt.hashSync('edit1', 10);
  const edit2 = bcrypt.hashSync('edit2', 10);
